...
VALUE (4,'Núria Vidal',611112223,'nuria.vidal@example.com','C/ Balmes 10, Manresa',1);
...
VALUE ('Toni Ferrer',612345678,'toni.ferrer@example.com','AV. Falsa 123, Manresa',1);
-- No es pot repetir telefon duplicat.alte
...
-- No pot esser ja que el nom no pot ser null
SELECT * FROM Clients;
INSERT INTO Clients (nom,telefon,correu,adreca,client_actiu)
...
VALUE (3,'Alineació direcció','2025-10-22','09:30',45.00,0),
...
VALUE  (2,CURRENT_TIMESTAMP,180.00,'0','Revisió general i pneumàtics');
-- -----No se pot ja que el codi de id_treball que haruia de ser dos (2) esta duplicat.
...
-- No puc eliminar el Client amb el codi numero 1 perque se hauria de transformar totes les taules.
