...
-- 3.Mostra totes les pel·licules amb any de llançament (release_year) posterior a 2005 --
...
-- 5. Selecciona totes les pel·licules amb una durada (length) inferior a 90 minuts. --
...
WHERE release_year > 2000 AND rating IN ('PG', 'G' );
