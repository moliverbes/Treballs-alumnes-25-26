...
SELECT concat(first_name,last_name)AS "actor complet" FROM actor; 
...
-- 10 Mostra el nom complet dtots els actors ordenats pel cognom en ordre ascendent.
...
SELECT concat(first_name," ",last_name)AS "nom complet" FROM actor; 