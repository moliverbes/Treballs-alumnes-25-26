...
-- 1. Mostra totes les columnes de totes les pel-licules
SELECT * FROM film;

-- 2. Mostra id, títol i descripció de les pel·lícules amb rating PG-13
SELECT film_id AS "id", title AS "titol", description , rating FROM film
...
SELECT title, length AS "duracion" FROM film
