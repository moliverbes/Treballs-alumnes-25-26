...
SELECT first_name, last_name FROM actor;
 ...
 SELECT CONCAT_WS(' ',first_name, last_name) AS 'actor_complet' FROM actor;
  ...
  SELECT * FROM film
  WHERE length >120;
   -- 4.Mostra les pel·lícules que tenen una classificació (rating) diferent de PG-13.alter
   SELECT title, rating FROM film WHERE rating NOT LIKE 'PG-13';
    ...
    SELECT first_name, last_name FROM actor WHERE first_name LIKE '%LL%';
...
WHERE
   ...
   SELECT title, rating FROM film WHERE rating  NOT IN ('PG-13','G');
    ...
    SELECT * FROM film WHERE special_features IS NULL;
     ...
     SELECT CONCAT_WS(' ',first_name, last_name) AS 'Nom Complet' FROM actor ORDER BY last_name ASC;
    ...
    SELECT * FROM film WHERE length > 100 AND  rating LIKE 'PG';
	-- 13. Mostra les pel·lícules amb durada menor de 90 minuts i classificació “R”.
    SELECT * FROM film WHERE length <90 AND rating LIKE 'R';
    ...
    SELECT LOWER(title) FROM film WHERE rating LIKE 'PG-13';
